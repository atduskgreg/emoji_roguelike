...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("proto_flixel", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("proto_flixel", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "proto_flixel";
		app.meta["name"] = "proto_flixel";
